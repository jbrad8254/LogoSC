...
Current public API version: `2026.3`.
...
```scad
assert(LogoSCVersionAtLeast(2026, 3), "This model requires LogoSC 2026.3+");
```
...
profile/head illustrations, gallery timing warning, and prominent warning about the unknown
strength of printed fasteners.
